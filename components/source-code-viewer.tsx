    ...
    const fetchSourceCode = async () => {
        ...
        try {
            const response = await fetch(
                `/api/component-source/${componentName}`
            );
            ...
            >
                <SheetHeader className="pb-6">
                    <SheetTitle className="flex items-center gap-2">
                        ...
                        {sourceData?.component.title || componentName} Source
                        Code
                    </SheetTitle>
                    <SheetDescription>
                                ...
                                {(sourceData.component.dependencies ||
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className="flex flex-wrap gap-2">
                                            {sourceData.component.dependencies?.map(
                                                (dep) => (
                                                    <Badge
                                                        key={dep}
                                                        variant="secondary"
                                            ...
                                            {sourceData.component.registryDependencies?.map(
                                                (dep) => (
                                                    <Badge
                                                        key={dep}
                                                        variant="outline"
